          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`w-full  absolute right-0 z-30 rounded border-[.5px] bg-white border-body-color/50 py-4 
                ...
                >
                  <ul className="block lg:flex lg:space-x-12">
                    ...
                    <div className="my-12 gap-4 md:hidden flex items-center justify-center ">
                      {session !== null ? (
                        <Button
              ...
              <div className="hidden md:flex gap-4 items-center justify-end pr-16 lg:pr-0">
                {session !== null ? (
                  <Button
                    onClick={() => router.push("/create")}
                    text="Create"
